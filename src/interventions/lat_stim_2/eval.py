...
def main(
    ...
    for output_path, dataset in zip(
        ...
        if eval_datasets == None:
            ...
            prefix = "Consider the extent to which the responder follows the instruction below.\n"
            suffix = "\n\nThe probability that the responder followed the instruction"

            for e in dataset.examples:
                e["responses"] = {
                    prefix + r + suffix: e["responses"][r] for r in e["responses"]
                }
